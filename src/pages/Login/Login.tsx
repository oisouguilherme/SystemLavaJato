        ...
        <div className="px-4 flex flex-col space-y-3 w-full sm:w-96">
          ...
          <label className="flex flex-col">
            ...
            <input
              ...
              className="mt-1 p-4 bg-[#F2F4F8] shadow-md"
            />
            <p className="text-xs text-[#697077] pt-2">
              Informe uma senha segura
            </p>
          </label>
          <Link to="changepassword" className="text-blue-900 text-sm text-end">
            Esqueceu sua senha?
          </Link>
          ...
          <a href="#" className="text-azul-2 text-sm h underline">
            Não tem acesso? Clique aqui!
          </a>
        </div>
      </div>
    </div>
